...
class __TwigTemplate_083218965ff80babb9d37a623358f631c65e9804525fc410073fcfe0e2861821 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if (($this->getAttribute($this->getAttribute(($context["visitorData"] ?? $this->getContext($context, "visitorData")), "firstVisit", array()), "referrerType", array()) == "website")) {
            // line 10
            echo "                        <a href=\"";
            echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('safelink')->getCallable(), array($this->getAttribute($this->getAttribute(($context["visitorData"] ?? $this->getContext($context, "visitorData")), "firstVisit", array()), "referrerUrl", array()))), "html_attr");
            echo "\" target=\"_blank\">
                            ";
            // line 11
    ...
    ";
        ...
        if (($this->getAttribute($this->getAttribute(($context["visitorData"] ?? $this->getContext($context, "visitorData")), "lastVisits", array()), "getRowsCount", array(), "method") != 1)) {
            ...
            if (($this->getAttribute($this->getAttribute(($context["visitorData"] ?? $this->getContext($context, "visitorData")), "lastVisit", array()), "referrerType", array()) == "website")) {
                // line 28
                echo "                            <a href=\"";
                echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('safelink')->getCallable(), array($this->getAttribute($this->getAttribute(($context["visitorData"] ?? $this->getContext($context, "visitorData")), "lastVisit", array()), "referrerUrl", array()))), "html_attr");
                echo "\" target=\"_blank\">
                                ";
                // line 29
    ...
    {% endif %}
</div>", "@Live/_profileSummaryVisits.twig", "/home/aliened/Work/mana/my-bitnami-docker-matomo/bitnami-docker-matomo/plugins/Live/templates/_profileSummaryVisits.twig");
    }
}
