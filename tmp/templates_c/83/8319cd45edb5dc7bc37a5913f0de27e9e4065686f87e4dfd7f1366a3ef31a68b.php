...
class __TwigTemplate_1c915afe433ae5ba05f9713718db7381efac52848d566bd344a85f54f872a196 extends Twig_Template
{
...
<div class=\"visitor-profile-summary visitor-profile-resume\">
    ...
    <div>
        ";
        // line 8
        if ($this->getAttribute(($context["visitorData"] ?? $this->getContext($context, "visitorData")), "hasMoreVisits", array())) {
            // line 9
            echo "            <p>";
            echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Live_LimitedSummary", (("<strong>" . $this->getAttribute(($context["visitorData"] ?? $this->getContext($context, "visitorData")), "totalVisits", array())) . "</strong>")));
            echo "</p>
        ";
        }
        // line 11
        ...
        if (($this->getAttribute(($context["visitorData"] ?? $this->getContext($context, "visitorData")), "totalPageViews", array()) != $this->getAttribute(($context["visitorData"] ?? $this->getContext($context, "visitorData")), "totalActions", array()))) {
            ...
            // line 14
            echo "            ";
            if (($this->getAttribute(($context["visitorData"] ?? null), "totalEvents", array(), "any", true, true) && ($this->getAttribute(($context["visitorData"] ?? $this->getContext($context, "visitorData")), "totalEvents", array()) > 0))) {
        ...
        if ($this->getAttribute(($context["visitorData"] ?? null), "totalGoalConversions", array(), "any", true, true)) {
            ...
            if ($this->getAttribute(($context["visitorData"] ?? $this->getContext($context, "visitorData")), "totalGoalConversions", array())) {
                ...
                foreach ($context['_seq'] as $context["idGoal"] => $context["totalConversions"]) {
                    ...
                    // line 28
                    if ($this->getAttribute(($context["goals"] ?? null), $context["idGoal"], array(), "array", true, true)) {
                        // line 29
...
</div>", "@Live/_profileSummary.twig", "/home/aliened/Work/mana/my-bitnami-docker-matomo/bitnami-docker-matomo/plugins/Live/templates/_profileSummary.twig");
    }
}
