...
class __TwigTemplate_13db716a6acc62ad3db5d5916f30a4f3392c536a8ab9b9b7f33a62e1754d0afa extends Twig_Template
{
...
";
        ...
        <div class=\"visitor-profile-info\">
            ...
            if (twig_test_empty($this->getAttribute(($context["visitorData"] ?? $this->getContext($context, "visitorData")), "userId", array()))) {
                ...
                echo ": ";
                echo call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), array($this->getAttribute(($context["visitorData"] ?? $this->getContext($context, "visitorData")), "userId", array())));
                echo "\">";
                echo call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), array($this->getAttribute(($context["visitorData"] ?? $this->getContext($context, "visitorData")), "userId", array())));
                echo "</span>
                                ";
            ...
            if (($this->getAttribute($this->getAttribute(($context["visitorData"] ?? $this->getContext($context, "visitorData")), "lastVisits", array()), "getRowsCount", array(), "method") >= twig_constant("Piwik\\Plugins\\Live\\VisitorProfile::VISITOR_PROFILE_MAX_VISITS_TO_SHOW"))) {
                ...
                if ($this->getAttribute(($context["visitorData"] ?? $this->getContext($context, "visitorData")), "hasMoreVisits", array())) {
                    // line 79
                    echo "                                ";
                    echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Live_LimitedVisitsShown", (("<strong>" . $this->getAttribute(($context["visitorData"] ?? $this->getContext($context, "visitorData")), "totalVisits", array())) . "</strong>")));
                    echo "
                            ";
                } else {
                    // line 81
...
{% endif %}", "@Live/getVisitorProfilePopup.twig", "/home/aliened/Work/mana/my-bitnami-docker-matomo/bitnami-docker-matomo/plugins/Live/templates/getVisitorProfilePopup.twig");
    }
}
