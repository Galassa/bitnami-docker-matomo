...
class __TwigTemplate_6539e058ee0babb7f2dd9a9b0c25d4ad1ec6d842d76b85784a83bb96f36715ea extends Twig_Template
{
    ...
    <div piwik-content-intro>
        ...
        if (($context["isMarketplaceEnabled"] ?? $this->getContext($context, "isMarketplaceEnabled"))) {
            // line 21
            echo "                ";
            echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("CorePluginsAdmin_TeaserExtendPiwikByPlugin", (("<a href=\"" . \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFunction('linkTo')->getCallable(), array(array("action" => "browsePlugins", "sort" => null, "activated" => null))), "html_attr")) . "\">"), "</a>", "<a href=\"#\" class=\"uploadPlugin\">", "</a>"));
            // line 26
            echo "
            ";
        }
        ...
        echo "
            ";
        // line 33
        echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("CorePluginsAdmin_ChangeLookByManageThemes", (("<a href=\"" . \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFunction('linkTo')->getCallable(), array(array("action" => "themes", "activated" => null))), "html_attr")) . "\">"), "</a>"));
        echo "
        </p>
    </div>
...
{% endblock %}", "@CorePluginsAdmin/plugins.twig", "/home/aliened/Work/mana/my-bitnami-docker-matomo/bitnami-docker-matomo/plugins/CorePluginsAdmin/templates/plugins.twig");
    }
}
